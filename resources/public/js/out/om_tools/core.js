...
if(typeof om_tools.core.t_om_tools$core32812 !== 'undefined'){
} else {
...
*/
om_tools.core.t_om_tools$core32812 = (function (state_proxy,owner,get_state,meta32813){
...
om_tools.core.t_om_tools$core32812.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (get_state){
return (function (_32814,meta32813__$1){
var self__ = this;
var _32814__$1 = this;
return (new om_tools.core.t_om_tools$core32812(self__.state_proxy,self__.owner,self__.get_state,meta32813__$1));
});})(get_state))
;

om_tools.core.t_om_tools$core32812.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (get_state){
return (function (_32814){
var self__ = this;
var _32814__$1 = this;
...
om_tools.core.t_om_tools$core32812.prototype.cljs$core$IDeref$_deref$arity$1 = ((function (get_state){
return (function (_){
var self__ = this;
var ___$1 = this;
...
om_tools.core.t_om_tools$core32812.prototype.cljs$core$IReset$_reset_BANG_$arity$2 = ((function (get_state){
return (function (_,v){
var self__ = this;
var ___$1 = this;
...
om_tools.core.t_om_tools$core32812.prototype.cljs$core$ISwap$_swap_BANG_$arity$2 = ((function (get_state){
return (function (s,f){
var self__ = this;
var s__$1 = this;
...
om_tools.core.t_om_tools$core32812.prototype.cljs$core$ISwap$_swap_BANG_$arity$3 = ((function (get_state){
...
om_tools.core.t_om_tools$core32812.prototype.cljs$core$ISwap$_swap_BANG_$arity$4 = ((function (get_state){
...
om_tools.core.t_om_tools$core32812.prototype.cljs$core$ISwap$_swap_BANG_$arity$5 = ((function (get_state){
...
om_tools.core.t_om_tools$core32812.getBasis = ((function (get_state){
return (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"state-proxy","state-proxy",1999831324,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"owner","owner",1247919588,null)], null))),new cljs.core.Keyword(null,"doc","doc",1913296891),"Returns an atom-like object for reading and writing Om component\n   state.\n\n   Note: Behavior may exactly not match atoms when deref'ing\n   immediately following a reset!/swap! because Om processes state\n   changes asynchronously in separate render phases."], null)),new cljs.core.Symbol(null,"owner","owner",1247919588,null),new cljs.core.Symbol(null,"get-state","get-state",-1081972112,null),new cljs.core.Symbol(null,"meta32813","meta32813",51176522,null)], null);
});})(get_state))
;

om_tools.core.t_om_tools$core32812.cljs$lang$type = true;

om_tools.core.t_om_tools$core32812.cljs$lang$ctorStr = "om-tools.core/t_om_tools$core32812";

om_tools.core.t_om_tools$core32812.cljs$lang$ctorPrWriter = ((function (get_state){
return (function (this__18212__auto__,writer__18213__auto__,opt__18214__auto__){
return cljs.core._write.call(null,writer__18213__auto__,"om-tools.core/t_om_tools$core32812");
});})(get_state))
;

om_tools.core.__GT_t_om_tools$core32812 = ((function (get_state){
return (function om_tools$core$state_proxy_$___GT_t_om_tools$core32812(state_proxy__$1,owner__$1,get_state__$1,meta32813){
return (new om_tools.core.t_om_tools$core32812(state_proxy__$1,owner__$1,get_state__$1,meta32813));
});})(get_state))
;

}

return (new om_tools.core.t_om_tools$core32812(om_tools$core$state_proxy,owner,get_state,cljs.core.PersistentArrayMap.EMPTY));
} else {
return null;
}
});
...
var args32815 = [];
var len__18672__auto___32818 = arguments.length;
var i__18673__auto___32819 = (0);
while(true){
if((i__18673__auto___32819 < len__18672__auto___32818)){
args32815.push((arguments[i__18673__auto___32819]));

var G__32820 = (i__18673__auto___32819 + (1));
i__18673__auto___32819 = G__32820;
continue;
} else {
}
break;
